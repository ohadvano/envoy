...
TEST_P(FcdsIntegrationTest, FcdsUpdateWhilePreviousFcdsUpdatesAreInitializing) {
  ...
  expectConfigDump({ExpectedListenerDump{listeners_v1_, filter_chains_v1_, listener, {}},
                    ExpectedListenerDump{listeners_v1_,
                                         filter_chains_v1_,
                                         listener,
                                         {filter_chain, filter_chain_2, filter_chain_3},
                                         true}});
  ...
  expectConfigDump({ExpectedListenerDump{
      listeners_v1_, filter_chains_v1_, listener, {filter_chain, filter_chain_2, filter_chain_3}}});
