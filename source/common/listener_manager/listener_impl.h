...
private:
  ...
  std::unique_ptr<Init::TargetImpl> tracking_init_target_;
  std::unique_ptr<Init::WatcherImpl> tracking_init_watcher_;
  ...
  std::vector<std::shared_ptr<Init::TargetImpl>> parents_listener_init_target_;
  ...
  std::vector<std::shared_ptr<Init::Manager>> parents_dynamic_init_manager_;
  ...
  std::vector<std::shared_ptr<Init::WatcherImpl>> parents_local_init_watcher_;
