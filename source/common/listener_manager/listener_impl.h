...
private:
  ...
  std::shared_ptr<Init::TargetImpl> parent_listener_init_target_;
  ...
  std::shared_ptr<Init::Manager> parent_dynamic_init_manager_;
  ...
  std::shared_ptr<Init::WatcherImpl> parent_local_init_watcher_;
