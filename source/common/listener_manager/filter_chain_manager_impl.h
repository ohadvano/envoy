...
using FilterChainsByMatcher =
    absl::node_hash_map<
        envoy::config::listener::v3::FilterChainMatch, std::string, MessageUtil, MessageUtil>;
...
private:
  ...
  absl::optional<std::list<Network::DrainableFilterChainSharedPtr>> draining_filter_chains_;
};
